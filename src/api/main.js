...
const { proxyParser } = require('../helpers/proxy.helper');
const puppeteer = require('puppeteer-extra');
const { FingerprintGenerator, PRESETS } = require ('fingerprint-generator');
    ...
    return new Promise(async (resolve, reject) => {
      ...
      const StealthPlugin = Fingerprinter.createFingerprinterInterface({
        ...
        fingerprint_generator: {
          ...
          cpus: (e) => e >= 32,
          memory: (e) => e <= 64,
          compatibleMediaMimes: (e) => {
            return e.audio.includes('aac'), e.video['mp4'] && e.video.mp4.length > 0;
          },
          canvas: {
            chance: 95,
            shift: 4
